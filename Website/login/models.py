...
class Catalog(models.Model):
    ...
    description = models.CharField(db_column='DESCRIPTION', max_length=4096, blank=True,
...
class Order(models.Model):
    ...
    driver = models.IntegerField(db_column='DRIVER_ID', blank=True, null=True)  # Field name made lowercase.
...
class SponsorOrg(models.Model):
    org_id = models.IntegerField(db_column='ORG_ID', primary_key=True)  # Field name made lowercase.
    catalog_id = models.IntegerField(db_column='CATALOG_ID', blank=True, null=True)  # Field name made lowercase.
    org_name = models.CharField(db_column='ORG_NAME', max_length=255, blank=True,
                                null=True)  # Field name made lowercase.
